...
//
//   /// Add a new alarm
//   void _addAlarm(String time, String date) {
//     setState(() {
//       alarms.add({'time': time, 'date': date, 'enabled': true});
//     });
//     _saveAlarms();
//   }
//
//   /// Show bottom sheet to add alarm
...
//                   decoration: InputDecoration(
//                     labelText: 'Date (e.g., Fri 25 Sep 2025)',
//                     border: OutlineInputBorder(),
//                   ),
//                 ),
//                 SizedBox(height: 20),
...
//                       _addAlarm(timeController.text, dateController.text);
...
//                   ),
//                   child: Text('Add Alarm', style: TextStyle(fontSize: 18)),
//                 ),
//               ],
//             ),
//           );
